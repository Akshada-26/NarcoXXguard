...
public class DeepBreathingActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        // Load YouTube video
        String youtubeVideoId = "npgsYxdkMwWk6n1N"; // Replace with your YouTube video ID
        String youtubeUrl = "https://www.youtube.com/embed/DbDoBzGY3vo?si=" + youtubeVideoId;
